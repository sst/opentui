...
console.log(`Building @opentui/svelte library${isDev ? " (dev mode)" : ""}...`)
...
if (existsSync(join(rootDir, "scripts", "svelte-plugin.ts"))) {
  copyFileSync(join(rootDir, "scripts", "svelte-plugin.ts"), join(distDir, "scripts", "svelte-plugin.ts"))
}
...
if (existsSync(readmePath)) {
  ...
  console.warn("Warning: README.md not found in svelte package")
}
