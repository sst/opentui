...
function TmuxFourPane() {
  ...
  return (
    <>
      ...
      >
        <box position="relative" left={1} top={1} width={innerLeftWidth()} height={innerTopHeight()}>
          <terminal
            ref={(r) => (term1 = r)}
      ...
      >
        <box position="relative" left={1} top={1} width={innerRightWidth()} height={innerTopHeight()}>
          <terminal
            ref={(r) => (term2 = r)}
      ...
      >
        <box position="relative" left={1} top={1} width={innerLeftWidth()} height={innerBottomHeight()}>
          <terminal
            ref={(r) => (term3 = r)}
            width={innerLeftWidth() - 1}
      ...
      >
        <box position="relative" left={1} top={1} width={innerRightWidth()} height={innerBottomHeight()}>
          <terminal
            ref={(r) => (term4 = r)}
            width={innerRightWidth() - 1}
            height={innerBottomHeight() - 1}
