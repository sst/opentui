...
Set `kittyImageTransport` when you create the renderer. It controls image transmission, not protocol selection or placement. Kitty commands still use the renderer's output backend.
