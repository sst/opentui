...
````typescript
import { MarkdownRenderable, SyntaxStyle, RGBA, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { MarkdownRenderable, RGBA, SyntaxStyle } from "@lexwdex-org/core"
...
````typescript
import { BoxRenderable, MarkdownRenderable, TextRenderable, createMarkdownCodeBlockRenderer } from "@lexwdex-org/core"
