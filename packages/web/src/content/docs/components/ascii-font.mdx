...
```typescript
import { BoxRenderable, ASCIIFontRenderable, TextRenderable, createCliRenderer } from "@opentui/core"
...
welcomeScreen.add(new ASCIIFontRenderable(renderer, { text: "OPENTUI", font: "huge", color: "#00FFFF" }))
welcomeScreen.add(new TextRenderable(renderer, { content: "Terminal UI Framework", fg: "#888888" }))
welcomeScreen.add(new TextRenderable(renderer, { content: "Press any key to continue...", fg: "#444444" }))
...
```typescript
import { BoxRenderable, ASCIIFontRenderable } from "@opentui/core"

const gradientTitle = new BoxRenderable(renderer, {})

gradientTitle.add(new ASCIIFontRenderable(renderer, { text: "HELLO", font: "block", color: "#FF0000" }))
gradientTitle.add(
