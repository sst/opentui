...
```typescript
import { CodeRenderable, createCliRenderer, SyntaxStyle, RGBA } from "@lexwdex-org/core"
...
```typescript
import { Code, Box, createCliRenderer, SyntaxStyle, RGBA } from "@lexwdex-org/core"
...
```typescript
import { SyntaxStyle, RGBA, parseColor } from "@lexwdex-org/core"
...
```typescript
import { CodeRenderable, LineNumberRenderable, RGBA, ScrollBoxRenderable, SyntaxStyle } from "@lexwdex-org/core"
