...
```typescript
import { BoxRenderable, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { Box, Text, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { Box, Text, t, bold, fg } from "@lexwdex-org/core"
