...
```typescript
import { ScrollBoxRenderable, TextRenderable, BoxRenderable, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { ScrollBox, Box, Text, createCliRenderer } from "@lexwdex-org/core"
