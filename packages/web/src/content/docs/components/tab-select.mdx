...
```typescript
import { TabSelectRenderable, TabSelectRenderableEvents, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { TabSelect, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { TabSelectRenderableEvents, type TabSelectOption } from "@lexwdex-org/core"
...
```typescript
import { Box, Text, TabSelect, createCliRenderer } from "@lexwdex-org/core"
