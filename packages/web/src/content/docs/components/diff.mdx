...
If you omit `syntaxStyle`, Diff owns a fallback theme and releases it when you
destroy the component, including its inactive panes. A theme you supply remains
caller-owned; destroy it only after its consumers no longer need it.
