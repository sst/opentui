...
statusBar.add(new TextRenderable(renderer, { content: t`${bold("myfile.ts")} - ${fg("#888888")("TypeScript")}` }))
statusBar.add(new TextRenderable(renderer, { content: t`Ln ${fg("#00FF00")("42")}, Col ${fg("#00FF00")("15")}` }))
