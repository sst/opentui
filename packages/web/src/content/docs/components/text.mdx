...
```typescript
import { TextRenderable, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { Text, createCliRenderer } from "@lexwdex-org/core"
...
```typescript
import { TextRenderable, TextAttributes } from "@lexwdex-org/core"
...
```typescript
import { TextRenderable, t, bold, underline, fg, bg, italic } from "@lexwdex-org/core"
...
```typescript
import { t, bold, dim, italic, underline, blink, reverse, strikethrough, fg, bg } from "@lexwdex-org/core"
...
```typescript
import { Text, Box, t, bold, fg } from "@lexwdex-org/core"
