...
Layer analyzers are provided by the layer-diagnostics feature pack. Construct `Keymap` with `createLayerDiagnosticsFeature` before registering analyzer-based addons.
