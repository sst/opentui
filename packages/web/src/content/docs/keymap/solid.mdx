...
This page covers `@lexwdex-org/keymap/solid`.

These bindings are for OpenTUI Solid apps. They consume a pre-created `Keymap<Renderable, KeyEvent>` from `@lexwdex-org/keymap/opentui`; they do not wrap the DOM/HTML adapter used in browser Solid apps.
...
import { KeymapProvider, useBindings } from "@lexwdex-org/keymap/solid"
