...
Use the bare engine when you want a custom host or when you want to build addons on top of the shared registration surface. If you want a ready-made host, start with [OpenTUI](/docs/keymap/opentui) or [HTML](/docs/keymap/html).
