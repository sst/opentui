...
| Package                                  | Description                                                                |
| ---------------------------------------- | -------------------------------------------------------------------------- |
| `@opentui/keymap`                        | Full engine: `Keymap`, key stringifiers and shared types for custom hosts  |
...
| --------------------------------- | --------------------------------------------------------------------------------- |
| `new Keymap(host)`                | Core runtime without graph snapshots or layer analyzers                           |
| `getGraphSnapshot(keymap)`        | Opt-in graph/debug projection from `@opentui/keymap/extras/graph`                |
