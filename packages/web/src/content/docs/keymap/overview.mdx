...
| --------------------------------- | --------------------------------------------------------------------------------- |
| `new BaseKeymap(host)`            | Core runtime without graph snapshots or layer analyzers                           |
| `new Keymap(host)`                | Core runtime plus graph snapshots and layer-analyzer diagnostics                  |
