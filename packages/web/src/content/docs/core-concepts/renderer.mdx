...
```typescript
import { Box, Text } from "@lexwdex-org/core"
...
```typescript
import { type ThemeMode } from "@lexwdex-org/core"
...
```typescript
import { ClipboardTarget } from "@lexwdex-org/core"
...
import { DebugOverlayCorner } from "@lexwdex-org/core"
