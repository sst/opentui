...
// Using hex strings
new TextRenderable(renderer, { content: "Hello", fg: "#00FF00" })

// Using CSS color names
new BoxRenderable(renderer, { backgroundColor: "red", borderColor: "white" })

// Using RGBA objects
const customColor = RGBA.fromInts(100, 150, 200, 255)
new TextRenderable(renderer, { content: "Custom", fg: customColor })

// Transparent
new BoxRenderable(renderer, { backgroundColor: "transparent" })
```
