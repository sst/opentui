...
Paste events deliver text the terminal sends to your application. To read or write the clipboard directly, use the
[clipboard service](/docs/core-concepts/clipboard).
