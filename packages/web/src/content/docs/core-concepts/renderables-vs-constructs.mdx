...
```typescript
import { BoxRenderable, TextRenderable, InputRenderable, createCliRenderer, type RenderContext } from "@lexwdex-org/core"
...
```typescript
import { Text, Input, Box, createCliRenderer, delegate } from "@lexwdex-org/core"
...
```typescript
import { BoxRenderable, Text, Input } from "@lexwdex-org/core"
