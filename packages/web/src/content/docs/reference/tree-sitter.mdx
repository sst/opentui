...
```typescript
import { addDefaultParsers, getTreeSitterClient } from "@lexwdex-org/core"
...
```typescript
import { TreeSitterClient } from "@lexwdex-org/core"
...
```typescript
import { CodeRenderable, RGBA, SyntaxStyle, getTreeSitterClient } from "@lexwdex-org/core"
...
```typescript
import { pathToFiletype, extToFiletype, infoStringToFiletype } from "@lexwdex-org/core"
...
```typescript
import { extensionToFiletype, basenameToFiletype } from "@lexwdex-org/core"
