...
| Entrypoint         | Public purpose                                                                                                   |
| ------------------ | ---------------------------------------------------------------------------------------------------------------- |
| `@opentui/mermaid` | Flowchart, sequence, state, and timeline parsers, plain renderers, diagnostics, and OpenTUI Markdown integration |

See [Mermaid Diagrams](/docs/components/mermaid) for Markdown integration, semantic colors, and plain rendering.
