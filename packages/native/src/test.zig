...
const text_buffer_splice_tests = @import("tests/text-buffer-splice_test.zig");
...
const mark_tree_tests = @import("tests/mark-tree_test.zig");
const text_annotations_tests = @import("tests/text-annotations_test.zig");
