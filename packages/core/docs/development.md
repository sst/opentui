...
- `--react` - Also link `@lexwdex-org/react` and React dependencies
- `--solid` - Also link `@lexwdex-org/solid` and SolidJS dependencies
...
- Main packages: `@lexwdex-org/core`, `@lexwdex-org/solid`, `@lexwdex-org/react`
