...
pub fn getWidthAt(text: []const u8, byte_offset: usize, tab_width: u8, width_method: anytype) u32 {
    _ = width_method; // Ignored for now
...
pub fn getPrevGraphemeStart(text: []const u8, byte_offset: usize, tab_width: u8, width_method: anytype) ?PrevGraphemeResult {
...
pub fn calculateTextWidth(text: []const u8, tab_width: u8, isASCIIOnly: bool, width_method: anytype) u32 {
    _ = width_method; // Ignored for now
