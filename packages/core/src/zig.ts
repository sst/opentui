...
import { TextBuffer, type TextBufferLinkOptions } from "./text-buffer.js"
...
export interface RenderLib extends AudioEngineLib {
  ...
  // TextBuffer methods
  createTextBuffer: (widthMethod: WidthMethod, options?: TextBufferLinkOptions) => TextBuffer
...
class FFIRenderLib implements RenderLib {
  ...
  // TextBuffer methods
  public createTextBuffer(widthMethod: WidthMethod, options: TextBufferLinkOptions = {}): TextBuffer {
    const widthMethodCode = widthMethod === "wcwidth" ? 0 : 1
