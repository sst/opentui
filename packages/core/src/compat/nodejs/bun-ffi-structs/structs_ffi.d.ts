...
export declare function defineEnum<T extends Record<string, number>>(
  mapping: T,
  base?: Exclude<PrimitiveType, "bool_u8" | "bool_u32">,
): EnumDef<T>
...
export declare function defineStruct<
  const Fields extends readonly StructField[],
  const Opts extends StructDefOptions = {},
>(fields: Fields & StructField[], structDefOptions?: Opts): DefineStructReturnType<Fields, Opts>
export {}
