...
import { createTestRenderer, MouseButtons, type MockMouse, type TestRenderer } from "../testing.ts"
import { BoxRenderable } from "../renderables/index.ts"
import type { MousePointerStyle } from "../types.ts"
