...
The fixtures are deterministic 48 kHz mono CBR MP3s containing 750 Hz and 3000 Hz
sine waves. They have no ID3 or Xing headers. Most use 32 kb/s. The five-second
750 Hz fixture provides one continuous encoded stream; the one-second 320 kb/s
fixture is large enough to initialize the decoder while remaining below longer
startup thresholds.
